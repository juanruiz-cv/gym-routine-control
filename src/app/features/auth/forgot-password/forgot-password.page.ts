...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, RouterLink, LucideArrowLeft, LucideMail, LucideSend],
  template: `
    <div class="flex flex-col gap-6 animate-fade-in">
      <div class="text-center">
        ...
        <p class="text-on-surface-muted mt-1 text-sm">Enter your email and we'll send you a reset link</p>
      </div>
...
export class ForgotPasswordPage {
  ...
  protected async onSubmit(): Promise<void> {
    ...
    else this.successMessage.set('Reset link sent! Check your email.');
