-- ================================================================
-- Gym Routine Control — Complete Schema
...
-- 9. Auto-create profile on signup (SECURITY DEFINER bypasses RLS)
...
-- 10. Calculate estimated 1RM (Epley formula)
...
drop policy if exists "Users can create sessions" on public.workout_sessions;
...
drop policy if exists "Users can create PRs" on public.personal_records;
